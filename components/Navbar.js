...
const Navbar = () => {
  ...
  return (
    <>
      {showNavbar && (
        <nav className="bg-white w-[90vw] flex justify-between absolute top-10 right-[5vw] rounded-full p-4 px-7">
          ...
          <div className="flex gap-3">
            <button className="login bg-[#EFF0EC] px-7 py-4 rounded-lg font-semibold text-lg">
              Log in
            </button>
            <button className="signup bg-gray-900 text-white p-4 rounded-full font-bold">
              Sign up free
            </button>
          </div>
        </nav>
